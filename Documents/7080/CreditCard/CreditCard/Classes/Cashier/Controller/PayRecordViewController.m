...
- (void)getOrderList
{
    ...
    [parametersDict setObject:[NSNumber numberWithInt:6] forKey:@"OrderType"];
...
{
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(10, 0, MainScreenCGRect.size.width - 20, MainScreenCGRect.size.height - 64) style:UITableViewStyleGrouped];
