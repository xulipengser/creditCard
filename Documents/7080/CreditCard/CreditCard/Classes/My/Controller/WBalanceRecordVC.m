...
@interface WBalanceRecordVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation WBalanceRecordVC
...
- (void)getOrderList
{
    ...
    [parametersDict setObject:[NSNumber numberWithInt:3] forKey:@"OrderType"];
