...
@property (nonatomic,copy)void(^CameraImage)(UIImage *cameraImage, UIImage *thumbImage);
@property (nonatomic,copy)void(^AlbumArray)(NSArray *albumArray, NSArray *thumbArray);
@end

@implementation MLDPhotoManager

+ (void)showPhotoManager:(UIView *)carryView
         withCameraImage:(void(^)(UIImage *cameraImage, UIImage *thumbImage))cameraImage
          withAlbumArray:(void(^)(NSArray *albumArray, NSArray *thumbArray))albumArray
{
...
- (void)presentPhotoPickerViewControllerWithStyle:(LGShowImageType)style
{
    ...
    pickerVc.callBack = ^(NSArray *assets)
    {
        ...
        self.AlbumArray(originImageArray, thumbImageArray);
    };
    self.showType = style;
...
- (void)presentCameraSingle
{
    ...
    cameraVC.callback = ^(NSArray *cameras)
    {
        ...
        UIImage *thumbImg = [UIImage scaleImage:image ToSize:CGSizeMake(75, 75)];  // 缩略图
        self.CameraImage(image, thumbImg);
    };
