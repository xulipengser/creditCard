...
//        self.layer.shadowOpacity=.2;
        ...
        _titleNomalColor=[UIColor colorWithHexString:@"#666666"];
        _titleSelectColor= [UIColor colorWithHexString:MainColor];
        ...
        UIImageView *lineView = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.frame.size.height-defaultLineH, self.frame.size.width, defaultLineH)];
        lineView.backgroundColor = [UIColor colorWithHexString:@"E5E5E5"];
        [_bgScrollView addSubview:lineView];
        
        _selectLine=[[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height-defaultLineH, _btn_w, defaultLineH)];
        _selectLine.backgroundColor=[_titleSelectColor colorWithAlphaComponent:0.4];
...
-(void)btnClick:(UIButton *)btn{
    ...
    [UIView animateWithDuration:.2 animations:^{
        ...
        _selectLine.frame=CGRectMake(btn.frame.origin.x, self.frame.size.height-defaultLineH, btn.frame.size.width, defaultLineH);
