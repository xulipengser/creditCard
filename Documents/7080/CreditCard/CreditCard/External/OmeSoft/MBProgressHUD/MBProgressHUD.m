...
- (void)layoutSubviews {
    ...
    CGSize labelSize = HP_MULTILINE_TEXTSIZE(label.text, label.font, CGSizeMake(INT_MAX, INT_MAX), NSLineBreakByWordWrapping);
	...
	CGSize detailsLabelSize = HP_MULTILINE_TEXTSIZE(detailsLabel.text, detailsLabel.font, maxSize, detailsLabel.lineBreakMode);
